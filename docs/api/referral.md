...
- Vecozo kan gebruik maken van een door Vecozo zelf uitgegeven sleutel/ certificaat 
- Vecozo vereist geen PKIO certificaat van het Zorgplatform, ieder door een CA uitgegeven certificaat volstaat (klanten maken vaak al gebruik van certificaten die zijn uitgegeven door VECOZO voor andere diensten)
...
- De waarde van aud veld kan door de zorgaanbieder worden ingesteld. Vooralsnog is dat een vrije waarde, maar mogelijk zal Vecozo in de toekomst een AGB code meesturen.
