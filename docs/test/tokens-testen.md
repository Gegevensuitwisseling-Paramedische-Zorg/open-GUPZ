...
Gebruik de jwtcli commandline tool om een JWE authentcatietoken te genereren met opgegeven inhoud. De JWE is gesigned en encrypted zoals beschreven in [/docs/api/security.md](security.md) 
